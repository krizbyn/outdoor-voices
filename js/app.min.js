...
if (document.querySelector('.slider-just-in__body')) {
	new Swiper('.slider-just-in__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 2,
		spaceBetween: 2,
...
if (document.querySelector('.slider-recreate__body')) {
	new Swiper('.slider-recreate__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 2,
		spaceBetween: 2,
		...
		// Arrows
		navigation: {
			nextEl: '.slider-arrow-recreate .slider-arrow_next',
			prevEl: '.slider-arrow-recreate .slider-arrow_prev',
		},
		breakpoints: {
			// when window width is >= 320px
			320: {
